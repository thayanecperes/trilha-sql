...
-- colocamos na primeira condição quem tem mais chances de ma saida
--verdadeira, pois a segunda condicao nao sera checada nesse caso.
-- ROUPAS TEM O MAIOR NUMERO 
--- QUERY */
...
/* FEMININO VAI PRIMEIRO POR TER MENOR NUMERO */
...
/* MASCULINO VAI PRIMEIRO POR TER MAIOR NUMERO */
